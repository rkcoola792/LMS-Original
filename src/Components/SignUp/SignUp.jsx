      ...
      <div className="right-form flex flex-col gap-4  z-[20] sm:p-10 lg:p-16 p-4  lg:w-[70%] rounded-l-3xl  ">
            ...
            <div className="mid-form  flex flex-col gap-4 text-sm   ">
                ...
                <p className='font-semibold' >Full Name</p>
                    <input type="email" placeholder='Enter your full name'  className='border border-gray-200 p-3 px-3 text-xs w-full rounded'/>
                </div>
                <div className="input-field flex flex-col gap-1">
                ...
                <p className='font-semibold'>Confirm Password</p>
                    <input type="password" placeholder='Confirm your password'  className='border border-gray-200 p-3 px-3 text-xs w-full rounded'/>
                </div>
                <button className='p-3 bg-mainBlue rounded text-white'><p>Create an account</p></button>

                <p className='text-center font-semibold'>Already have an account? <span className='text-mainBlue cursor-pointer'>Login</span></p>
